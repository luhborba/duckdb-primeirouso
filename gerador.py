...
lista_produtos = {'Computador': 2000, 'Celular Xiaomi': 1000, 'Celular Samsung': 1500, 'Celular Iphone': 5000,
                  'Monitor': 700, 'Teclado': 50, 'Mouse': 20, 'HeadSet': 100, 'HeadSet JBL': 250,
                  'Carregador Iphone': 105, 'Carregador Samsung': 80, 'Carregador Xiaomi': 90,
                  'Carregador Motorola': 100, 'Carregador Nokia': 110, 'PenDrive 4 GB': 20,
                  'PenDrive 8 GB': 30, 'PenDrive 16 GB': 40}
cliente = []
   

def gerando_dados(total_linhas: int, total_clientes: int, nome_arquivo: str, tamanho_bloco: int = 100):
    falso = Faker()
