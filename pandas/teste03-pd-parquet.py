...
total_vendas_produtos.to_parquet('data/parquet/total_vendas_produtos.parquet', index=False)

# Salvando DF de Total De Vendas por Cliente
total_vendas_cliente.to_parquet('data/parquet/total_vendas_cliente.parquet', index=False)
